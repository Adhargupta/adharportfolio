...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "adhargpt@gmail.com",
    href: "mailto:adhargpt@example.com",
  },
  {
    icon: MapPin,
    label: "Location",
...
function Contact(){
  ...
  function toggle(){
    if(submitStatus.type === "success" || submitStatus.type === "error"){
    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          {/* Contact Info */}
          <div className="space-y-6 animate-fade-in animation-delay-400 flex flex-col justify-center">
